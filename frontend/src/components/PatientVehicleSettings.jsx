...
import PatientVehicleRegistration from "./PatientVehicleRegistration";

const PatientVehicleSettings = () => {
    const [activeTab, setActiveTab] = useState("registration");

    let content;

    if (activeTab === "registration") {
    content = <PatientVehicleRegistration/>;
...
export default PatientVehicleSettings;
